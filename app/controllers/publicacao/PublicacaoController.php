...
class PublicacaoController {
    ...
    public function criarPublicacao($titulo, $conteudo, $imagemPublicacao, $dataPublicacao, $professor_id) {
        return $this->publicacaoModel->criarPublicacao($titulo, $conteudo, $imagemPublicacao, $dataPublicacao, $professor_id);
    }
    ...
    public function obterPublicacoesProfessor($professor_id) {
